...
{$ENDIF}
  ...
  FILEREADPROC = function(buffer: Pointer; length: Cardinal; user: Pointer): Cardinal;
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  STREAMPROC = function(handle: HSTREAM; buffer: Pointer; length: Cardinal; user: Pointer): Cardinal;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  {
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  DSPPROC = procedure(handle: HDSP; channel: Cardinal; buffer: Pointer; length: Cardinal; user:
    Pointer); {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  {
  ...
  RECORDPROC = function(handle: HRECORD; buffer: Pointer; length: Cardinal; user: Pointer): BOOL;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  {
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_GetDeviceInfo: function(device: Cardinal; var info: BASS_DEVICEINFO): BOOL;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
{$IFDEF MSWINDOWS}
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_GetEAXParameters: function(var env: Cardinal; var vol, decay, damp: FLOAT): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
{$ENDIF}
  BASS_MusicLoad: function(mem: BOOL; f: Pointer; offset: QWORD; length, flags, freq: Cardinal):
    HMUSIC; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_MusicFree: function(handle: HMUSIC): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleLoad: function(mem: BOOL; f: Pointer; offset: QWORD; length, max, flags: Cardinal):
    HSAMPLE; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleCreate: function(length, freq, chans, max, flags: Cardinal): HSAMPLE;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleGetChannels: function(handle: HSAMPLE; channels: Pointer): Cardinal; {$IFDEF MSWINDOWS}
    stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleStop: function(handle: HSAMPLE): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamCreate: function(freq, chans, flags: Cardinal; proc: STREAMPROC; user: Pointer):
    HSTREAM; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamCreateFile: function(mem: BOOL; f: Pointer; offset, length: QWORD; flags: Cardinal):
    HSTREAM; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamCreateURL: function(url: Pointer; offset: Cardinal; flags: Cardinal; proc: DOWNLOADPROC;
    user: Pointer): HSTREAM;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamCreateFileUser: function(system, flags: Cardinal; var procs: BASS_FILEPROCS; user:
    Pointer): HSTREAM; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamPutData: function(handle: HSTREAM; buffer: Pointer; length: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamPutFileData: function(handle: HSTREAM; buffer: Pointer; length: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordGetDeviceInfo: function(device: Cardinal; var info: BASS_DEVICEINFO): BOOL;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordSetInput: function(input: LongInt; flags: Cardinal; volume: FLOAT): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordGetInput: function(input: LongInt; var volume: FLOAT): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordStart: function(freq, chans, flags: Cardinal; proc: RECORDPROC; user: Pointer): HRECORD;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_ChannelGetInfo: function(handle: Cardinal; var info: BASS_CHANNELINFO): BOOL;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_ChannelSetAttribute: function(handle, attrib: Cardinal; value: FLOAT): BOOL;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetAttribute: function(handle, attrib: Cardinal; var value: FLOAT): BOOL;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSlideAttribute: function(handle, attrib: Cardinal; value: FLOAT; time: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelIsSliding: function(handle, attrib: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSet3DAttributes: function(handle: Cardinal; mode: LongInt; min, max: FLOAT; iangle,
    oangle, outvol: LongInt): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGet3DAttributes: function(handle: Cardinal; var mode: Cardinal; var min, max: FLOAT;
    var iangle, oangle, outvol: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSet3DPosition: function(handle: Cardinal; var pos, orient, vel: BASS_3DVECTOR): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGet3DPosition: function(handle: Cardinal; var pos, orient, vel: BASS_3DVECTOR): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetLength: function(handle, mode: Cardinal): QWORD;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetPosition: function(handle: Cardinal; pos: QWORD; mode: Cardinal): BOOL;
    {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_ChannelGetData: function(handle: Cardinal; buffer: Pointer; length: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetSync: function(handle: Cardinal; type_: Cardinal; param: QWORD; proc: SYNCPROC;
    user: Pointer): HSYNC; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelRemoveSync: function(handle: Cardinal; sync: HSYNC): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetDSP: function(handle: Cardinal; proc: DSPPROC; user: Pointer; priority: LongInt):
    HDSP; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
